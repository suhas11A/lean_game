...
// Module: Game.Levels.PropositionalLogic.L10_negHypo
...
LEAN_EXPORT lean_object* initialize_Game_Levels_PropositionalLogic_L10__negHypo(uint8_t builtin, lean_object* w) {
lean_object * res;

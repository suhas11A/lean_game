...
// Module: Game.Levels.PropositionalLogic.L07_bicondGoal
...
LEAN_EXPORT lean_object* initialize_Game_Levels_PropositionalLogic_L07__bicondGoal(uint8_t builtin, lean_object* w) {
lean_object * res;

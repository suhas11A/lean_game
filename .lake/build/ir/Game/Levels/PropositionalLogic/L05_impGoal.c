...
// Module: Game.Levels.PropositionalLogic.L05_impGoal
...
LEAN_EXPORT lean_object* initialize_Game_Levels_PropositionalLogic_L05__impGoal(uint8_t builtin, lean_object* w) {
lean_object * res;

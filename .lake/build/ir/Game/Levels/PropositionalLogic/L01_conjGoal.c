...
// Module: Game.Levels.PropositionalLogic.L01_conjGoal
...
LEAN_EXPORT lean_object* initialize_Game_Levels_PropositionalLogic_L01__conjGoal(uint8_t builtin, lean_object* w) {
lean_object * res;

...
// Module: Game.Levels.Functions.L12_preimage_codomain
...
LEAN_EXPORT lean_object* initialize_Game_Levels_Functions_L12__preimage__codomain(uint8_t builtin, lean_object* w) {
lean_object * res;

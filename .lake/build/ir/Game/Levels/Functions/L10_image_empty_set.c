...
// Module: Game.Levels.Functions.L10_image_empty_set
...
LEAN_EXPORT lean_object* initialize_Game_Levels_Functions_L10__image__empty__set(uint8_t builtin, lean_object* w) {
lean_object * res;

...
// Module: Game.Levels.Sets.L01_intro
// Imports: Init Game.Metadata Mathlib.Data.Set.Basic
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Game_Levels_Sets_L01__intro(uint8_t builtin, lean_object* w) {
lean_object * res;

...
// Module: Game.Levels.VariablesAndQuantifiers.L03_existentialGoal
...
LEAN_EXPORT lean_object* initialize_Game_Levels_VariablesAndQuantifiers_L03__existentialGoal(uint8_t builtin, lean_object* w) {
lean_object * res;

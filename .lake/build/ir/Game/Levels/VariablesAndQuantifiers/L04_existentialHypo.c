...
// Module: Game.Levels.VariablesAndQuantifiers.L04_existentialHypo
...
LEAN_EXPORT lean_object* initialize_Game_Levels_VariablesAndQuantifiers_L04__existentialHypo(uint8_t builtin, lean_object* w) {
lean_object * res;

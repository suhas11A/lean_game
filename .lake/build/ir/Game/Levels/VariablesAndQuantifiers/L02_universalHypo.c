...
// Module: Game.Levels.VariablesAndQuantifiers.L02_universalHypo
...
LEAN_EXPORT lean_object* initialize_Game_Levels_VariablesAndQuantifiers_L02__universalHypo(uint8_t builtin, lean_object* w) {
lean_object * res;

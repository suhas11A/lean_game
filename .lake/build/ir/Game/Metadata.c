...
// Module: Game.Metadata
// Imports: Init GameServer.Commands Game.Tactic Mathlib.Init.Data.Nat.Notation Mathlib.Tactic.Common
#include <lean/lean.h>
...
lean_object* initialize_Game_Tactic(uint8_t builtin, lean_object*);
...
LEAN_EXPORT lean_object* initialize_Game_Metadata(uint8_t builtin, lean_object* w) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Game_Tactic(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
